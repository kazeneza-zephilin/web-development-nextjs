...
import WexlyHelps from "@/components/WexlyHelps";
...
export async function generateMetadata(_, parent) {
    ...
    const imageUrl = image
        ? new URL(image.url, process.env.NEXT_PUBLIC_STRAPI).href
        : p.openGraph.images[0];
    ...
    if (global.status === "fulfilled") {
        ...
        jsonLd = {
            ...
            "@graph": [
                ...
                {
                    "@type": "WebSite",
                    "@id": new URL("/#website", process.env.NEXT_PUBLIC_WEBSITE)
                        .href,
                    url: new URL("/", process.env.NEXT_PUBLIC_WEBSITE).href,
                    name: siteName,
                ...
                },
                {
                    ...
                    "@id": isOrganization
                        ...
                        : new URL("/#person", process.env.NEXT_PUBLIC_WEBSITE)
                              .href,
                    name: siteName,
                    description: siteDescription,
                    url: new URL("/", process.env.NEXT_PUBLIC_WEBSITE).href,
    ...
    return (
        <>
            ...
            <div className="-mt-[69px]">
                <Hero data={hero} />
                <WhyWebsiteMatters data={about} />
                <WexlyHelps />
                <HowItWorks data={dynamicData} />
                <PricingCTA />
